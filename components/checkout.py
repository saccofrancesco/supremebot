...
class CheckoutUI:
    def __init__(self) -> None:
        ...
        pay_name_col, self.save_pay_method_col, self.buy_col = self.col2.columns(3)
        self.payment_method_name = pay_name_col.text_input(
            " ", label_visibility="collapsed", placeholder="Configuration Name")
